...
var categories = []Category {
	...
	Category{1671, 1562, "Диско-лампы и проекторы"},
	...
	Category{986, 1670, "Светодиодные прозрачные лампы 50 мм"},
	Category{983, 1670, "Лампы накаливания"},
	Category{1021, 1670, "RGB лампы"},
	Category{985, 1670, "Светодиодные матовые лампы 45 мм"},
	Category{984, 1670, "Светодиодные прозрачные лампы 45 мм"},
	Category{1149, 1670, "Светодиодные матовые лампы 100 мм"},
	Category{1520, 1670, "Ретро лампы"},
    //Category{306, 305, "Стробы"}, // вложенность +1
	Category{987, 306, "Стробы E27"},
	Category{988, 306, "Стробы накладные"},
	...
	// Category{313, 2, "Прожекторы светодиодные"},
	Category{368, 313, "Прожекторы цветные RGB"},
	Category{369, 313, "Прожекторы белые LED"},

	// Category{316, 2, "Светодиодные ленты"},
	Category{1631, 316, "Ленты 5 Вольт"},
	Category{415, 316, "Ленты 12 Вольт"},
	Category{1039, 316, "Ленты 24 Вольт"},
	Category{377, 316, "Ленты 220 Вольт"},
	Category{379, 316, "Аксессуары для ленты 12 - 24 Вольт"},
	Category{282, 316, "Аксессуары для ленты 220 Вольт"},
	Category{1461, 316, "Алюминиевый профиль"},
	Category{1119, 316, "Блоки питания"},
