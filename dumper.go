...
var categories = []Category {
    ...
    Category{1670, 305, "Лампы"},
    Category{1671, 305, "Диско-лампы и проекторы"},
    Category{306, 305, "Стробы"},
    ...
    Category{1632, 2, "Индивидуальная продукция под заказ"},
}
